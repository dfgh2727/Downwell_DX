...
Well::Well()
{
	...
	CollisionBox1->SetRelativeLocation({ -118.0f, 8.0f, 0.0f });
	...
	CollisionBox2->SetRelativeLocation({ 118.0f, 8.0f, 0.0f });
	...
	CollisionBox3->SetRelativeLocation({ -97.0f, 100.0f, 0.0f });
	...
	CollisionBox4->SetRelativeLocation({ 97.0f, 100.0f, 0.0f });
}
